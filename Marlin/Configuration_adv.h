 ...
 */
#define E0_AUTO_FAN_PIN P2_04//-1
...
#define EXTRUDER_AUTO_FAN_SPEED 255 //125//   // 255 == full speed
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V //CHOPPER_DEFAULT_12V
  ...
  #define MONITOR_DRIVER_STATUS
    ...
    #define CURRENT_STEP_DOWN     10 // 50  // [mA]
  ...
  #define E4_HYBRID_THRESHOLD     35
  #define E5_HYBRID_THRESHOLD     35
  #define E6_HYBRID_THRESHOLD     35
  #define E7_HYBRID_THRESHOLD     35
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define Y_STALL_SENSITIVITY  6 //8
